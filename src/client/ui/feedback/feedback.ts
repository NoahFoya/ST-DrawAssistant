...
let _lightboxHandler: ((imageUrl: string, prompt?: string, info?: any) => void) | null = null;

export function registerLightboxHandler(handler: (imageUrl: string, prompt?: string, info?: any) => void): void {
    _lightboxHandler = handler;
}
...
export class FeedbackService {
    ...
    public static registerLightboxHandler(handler: (imageUrl: string, prompt?: string, info?: any) => void): void {
        registerLightboxHandler(handler);
    }

    public static lightbox(imageUrl: string, prompt?: string, info?: any): void {
        if (_lightboxHandler) {
            _lightboxHandler(imageUrl, prompt, info);
