 ...
 * @description 标准化工作流预设卡片控件与变量诊断工具 (Workflow Preset Card Control)
 */
            ...
            html += `
                <div class="da-workflow-format-section">
                    <div class="da-workflow-format-section-title warning">
                        <i class="fa-solid fa-circle-exclamation"></i> 未自动匹配到的变量 (${unrepCount})
                    </div>
                    <div class="da-workflow-var-list">
            `;
            analysis.unmatched.forEach((u) => {
                html += `
                    <div class="da-workflow-var-item unmatched">
                        ...
                        <span class="da-workflow-var-tip">${u.tip}</span>
                    </div>
                `;
            });
            html += `</div></div>`;
