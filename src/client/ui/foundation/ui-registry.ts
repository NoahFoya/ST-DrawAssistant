/**
 * @module ui/foundation/ui-registry
 * @description UI 插槽与贡献点注册中心 (Tab 页、楼层操作按钮与悬浮球动作)
 */

import { IDisposable, toDisposable, Logger } from '../../core';
...
export interface FloorButtonSlotDescriptor {
    ...
    readonly icon?: string;
    shouldRender?(message: any): boolean;
...
export class UIRegistry implements IUIRegistry {
    ...
    /** 获取已注册 Tab 列表便捷别名 */
    public getRegisteredTabs(): TabSlotDescriptor[] {
        return this.getTabs();
    }
