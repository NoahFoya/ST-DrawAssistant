 ...
 *
 * 功能：
 * 1. 组合画幅比例预设下拉框、宽高数值微调输入框与宽高一键翻转按钮；
 * 2. 支持常见画幅比例 (1:1, 2:3, 3:2, 3:4, 4:3, 9:16, 16:9) 一键切换；
 * 3. 限制生图分辨率满足 64 像素潜空间步长对齐约束与极值范围保护。
 *
 * Tips：
 * 1. 手动微调宽高导致比例改变时，预设下拉框自动同步切换至自定义模式；
 * 2. 点击翻转按钮可快速置换当前宽高数值，并触发 onChange 回调。
 */
